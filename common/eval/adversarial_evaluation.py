...
class AdversarialEvaluation:
    ...
    def robust_correct_loss(self, loss=common.numpy.cross_entropy):
        """
        Loss.
        ...
        #return loss(self.test_adversarial_probabilities, self.reference_labels)
    ...
    def robust_loss(self, loss=common.numpy.cross_entropy):
        """
        Loss.
    ...
    def loss(self, loss=common.numpy.cross_entropy):
        """
        Loss.
        ...
        #return loss(self.test_probabilities, self.test_labels)
