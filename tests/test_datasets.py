...
class TestDatasets(unittest.TestCase):
    def setUp(self):
        ...
        common.utils.write_hdf5(self.images_file, self.images, chunks=(10, 32, 33, 3))
    ...
    def testResizeSmaller(self):
        ...
        self.assertAlmostEqual(numpy.mean(dataset.images), numpy.mean(self.images), 2)
    ...
    def testColor(self):
        ...
        grayscale = grayscale.reshape(grayscale.shape[0], grayscale.shape[1], grayscale.shape[2], 1)
