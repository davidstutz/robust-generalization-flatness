...
class AutoAttack():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if version in ['standard', 'plus', 'rand', 'es']:
    ...
    def run_standard_evaluation(self, x_orig, y_orig, bs=250):
        if self.verbose:
            ...
            print('using eps=%g' % self.epsilon)
    ...
    def set_version(self, version='standard'):
        ...
        if version == 'es':
            ...
            self.apgd_targeted.n_restarts = 5
            self.apgd_targeted.n_iter = 50
            ...
            self.attacks_to_run = ['fab-t', 'apgd-ce', 'apgd-t'] # , 'square'
